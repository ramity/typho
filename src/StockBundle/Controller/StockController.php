...
class StockController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $stocks = $em->getRepository('StockBundle:Stock')->findAll();
    ...
    {
        $stock = new Stock();
        $form = $this->createForm('StockBundle\Form\StockType', $stock);
    ...
    {
        $deleteForm = $this->createDeleteForm($stock);
        $editForm = $this->createForm('StockBundle\Form\StockType', $stock);
